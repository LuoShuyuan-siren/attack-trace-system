...
def build_default_rules() -> tuple[MappingRule, ...]:
    rules = [
        ...
        MappingRule(
            ...
            priority=82,
            tactic_ids=("TA0011",),
            tags=frozenset({"dns_tunnel", "dns-tunnel"}),
            ttp_tags=("dns_tunnel", "c2_communication"),
        ),
        MappingRule(
            ...
            priority=90,
            tactic_ids=("TA0011",),
            analyzers=frozenset({"http_tunnel_analyzer"}),
            ttp_tags=("http_tunnel", "c2_communication"),
        ),
        MappingRule(
            rule_id="tag-http-c2",
            name="HTTP covert channel or beacon tag",
            technique_id="T1071.001",
            priority=82,
            tactic_ids=("TA0011",),
            tags=frozenset({"http_tunnel", "beacon", "c2"}),
            ttp_tags=("http_tunnel", "c2_communication"),
        ),
        MappingRule(
        ...
        MappingRule(
            rule_id="tag-connection-c2",
            name="Connection beacon or C2 tag",
            technique_id="T1071.001",
            priority=80,
            tactic_ids=("TA0011",),
            tags=frozenset({"beacon", "c2"}),
            ttp_tags=("c2_communication",),
        ),
        MappingRule(
            rule_id="tag-port-scan",
            name="Port scan tag",
            technique_id="T1046",
            priority=80,
            tactic_ids=("TA0007",),
            tags=frozenset({"port_scan", "port-scan"}),
        ...
        MappingRule(
            rule_id="hb-credential-database-reference",
            name="Member4 credential database reference",
            technique_id="T1003.008",
            priority=92,
            tactic_ids=("TA0006",),
            text_patterns=("hb-proc-005",),
            ttp_tags=("credential_access", "credential_dumping"),
        ),
        MappingRule(
            rule_id="hb-credential-material-search",
            name="Member4 credential material search",
            technique_id="T1552.004",
            priority=92,
            tactic_ids=("TA0006",),
            text_patterns=("hb-proc-006",),
            ttp_tags=("credential_access", "private_keys"),
        ),
        MappingRule(
            rule_id="brute-force",
            name="Brute force",
